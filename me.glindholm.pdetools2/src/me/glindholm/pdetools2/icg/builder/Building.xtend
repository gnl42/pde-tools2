...
import me.glindholm.pdetools2.icg.builder.parts.ErrorPart
import me.glindholm.pdetools2.icg.builder.parts.IConstantGenerator
import me.glindholm.pdetools2.icg.builder.parts.JavaProjectPart
import me.glindholm.pdetools2.icg.builder.parts.ResourceDeltaPart
import me.glindholm.pdetools2.shared.ResourceExtensions
...
class Building {
  ...
  def IProject[ ] build(IProgressMonitor monitor) {
    ...
    var uri = URI::createPlatformResourceURI(project.fullPath.append('''.settings/«me::glindholm::pdetools2::PDEToolsCore::getDefault.bundle.symbolicName».palette.xml''').toPortableString, false)
