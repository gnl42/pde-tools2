...
class GraphitiImageCosntantGenerator implements IConstantGenerator{
	@Accessors ICGConfiguration config ;
	
	val ImagePreviewGenerator previewGenerator = new ImagePreviewGenerator()

	override generateJavaSource(Palette rootPalette) '''
		 ...
		 */
		public class « config.generateClassName » extends AbstractImageProvider{
		    ...
		    protected void addAvailableImages() {
		    	«FOR e : rootPalette.eAllContents.filter(typeof(ImageFile)).toList»
		    		addImageFilePath(«e.qualifiedName», "«e.file.projectRelativePath.toPortableString»");
		    	«ENDFOR»
		    }
		}
	'''
