package me.glindholm.pdetools2;
...
public class PDEToolsCore extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "me.glindholm.pdetools2"; //$NON-NLS-1$
	...
	private void handleActivityChanged() {
		...
		evalService.requestEvaluation("me.glindholm.pdetools2.isActivityEnabled");
		evalService.requestEvaluation("me.glindholm.pdetools2.isCategoryEnabled");
